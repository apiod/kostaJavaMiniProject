...
public class RentItemMenuView {
	...
	public void rentalMenu() {
		...
		while (true) {
			...
			System.out.println("6. 대여 중 물품 조회"); //borrowerid 기준
